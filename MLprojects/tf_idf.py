...
# Text classification for the 20 Newsgroups dataset using Logistic Regression.
# Extracts word frequencies (TF) and optionally applies Inverse Document Frequency (IDF).
# Predicts the category of newsgroup posts and evaluates performance using macro F1-score.
